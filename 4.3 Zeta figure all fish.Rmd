---
title: "4.3 Zeta figure all fish"
author: "TG"
date: "2023-06-27"
output:
   prettydoc::html_pretty:
    ...
    highlight: github
---
*In this script ill concentrate all the models and plot constructing the Zeta diversity figure for all species*
...
plot_path <- "G:\\My Drive\\PHD\\chapter 1 strom effect\\R_storm_ms\\plots\\Zeta\\all fish"
...
#ggsave("zeta_allfish_2018.pdf" , width = 9, height = 5, dpi = 300,path = plot_path)

#ggsave("zeta_allfish_2018.png" , width = 9, height = 5, dpi = 300,path = plot_path)
...
# ggsave("zeta_ratio_allfish_2018.pdf" , width = 9, height = 5, dpi = 300,path =plot_path)

# ggsave("zeta_ratio_allfish_2018.png" , width = 9, height = 5, dpi = 300,path =plot_path)
...
# how many species was present in 2020a
...
null_prep <- fish_prep %>% filter(year_month == "2018 b") %>%  
...
ind_null_prep <- fish_prep %>% filter(year_month == "2018 b") %>%  
  select(Site,year_month,knoll_id,DD_X,DD_Y,Species,Abundance) %>%
...
zeta_divesity_all_short<-zeta_divesity_all %>%
filter(year_month %in% c("2020 a","2018 b"))



ggplot(data =zeta_divesity_all_short,
       aes(x=z_order,y=zeta_value,color =year_month))+
  geom_line(size=0.5)+
  geom_point(size=4)+
  theme_classic()+
...
#ggsave("null_zeta_decay_all_fish.pdf" , width = 10, height = 5, dpi = 300,path = plot_path)

#ggsave("null_zeta_decay_all_fish.png" , width = 10, height = 5, dpi = 300,path = plot_path)
```
...
#ggsave("null_ratio_all_fish.pdf", width = 10, height = 5, dpi = 300,path = plot_path)

#ggsave("null_ratio_all_fish.png" , width = 10, height = 5, dpi = 300,path =plot_path)  
